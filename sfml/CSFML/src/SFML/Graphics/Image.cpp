...
////////////////////////////////////////////////////////////
/// Resize an image - warning : this function does not scale the image,
/// it just ajdusts size (add padding or remove pixels)
////////////////////////////////////////////////////////////
sfBool sfImage_Resize(sfImage* Image, unsigned int Width, unsigned int Height, sfColor Color)
{
    sf::Color SFMLColor(Color.r, Color.g, Color.b, Color.a);
    CSFML_CALL_RETURN(Image, Resize(Width, Height, SFMLColor), sfFalse);
}
