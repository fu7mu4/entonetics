...
// WARNING : this structure must always be the SAME as in Window/View.h
struct sfView
{
    sf::View* This;
};
...
////////////////////////////////////////////////////////////
void sfRenderWindow_SetBackgroundColor(sfRenderWindow* RenderWindow, sfColor Color)
{
    sf::Color SFMLColor(Color.r, Color.g, Color.b, Color.a);

    CSFML_CALL(RenderWindow, SetBackgroundColor(SFMLColor));
}
